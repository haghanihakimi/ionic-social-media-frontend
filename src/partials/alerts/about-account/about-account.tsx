...
const AboutAccount: React.FC = () => {
    ...
    return (
        <>
            {
                alerts.aboutAccount ?
                    <div id="about-account-alert" className='w-screen h-screen animate-opacityFade p-4 fixed z-[9999] top-0 flex justify-center items-center bg-black bg-opacity-50'>
                        <div ref={alertWrapper} className='w-full animate-alertFade h-auto bg-slate-50 p-6 relative rounded-lg border border-slate-200 shadow-lg'>
                            ...
                            <div className='w-full flex flex-row items-center justify-between gap-1'>
                                <button onClick={() => dispatch(toggleAboutAccount(false))}
                                    className='w-full ion-activatable ripple-parent outline-none rounded bg-transparent text-primary text-base font-medium py-1'>
                                    OK
