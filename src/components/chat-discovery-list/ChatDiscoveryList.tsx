...
const ChatDiscoveryListComp: React.FC = () => {

    return (
        <div className='flex flex-col gap-2 p-4 relative'>

            {/* Rows */}
            <div className='w-full p-2 ion-activatable ripple-parent text-secondary flex flex-col items-center justify-between gap-4 relative rounded-lg border border-slate-300 bg-slate-200'>
                ...
                <div className='w-full flex flex-row items-center justify-between'>
                    ...
                    <button className='bg-gradient-to-r from-secondary to-primary text-slate-200 rounded-full px-3 py-1 font-medium text-sm'>
                        Join
                    </button>
                </div>
...
export default ChatDiscoveryListComp;